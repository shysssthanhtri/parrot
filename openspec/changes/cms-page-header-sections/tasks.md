...
- [ ] 4.1 Manually verify Topics list, new, and detail routes on desktop and mobile: header shows toggle + correct breadcrumbs; **New topic** button and forms unchanged below header
- [ ] 4.2 Manually verify Scripts list, new, and detail routes on desktop and mobile: header shows toggle + correct breadcrumbs; loading skeleton matches list layout
- [ ] 4.3 Manually verify Speeches list, new, and detail routes on desktop and mobile: header shows toggle + correct breadcrumbs; speech detail behavior unchanged
- [ ] 4.4 Manually verify mobile sidebar toggle opens drawer and nav links still close the drawer on all three sections
