...
The CMS settings page SHALL present two tabbed sections: **Personal** and **CMS**. The Personal tab SHALL be selected by default when the page loads. The page SHALL be accessible only to authenticated CMS users (`isCmsUser === true`).
...
- **WHEN** an authenticated CMS user selects the Personal tab after viewing CMS
