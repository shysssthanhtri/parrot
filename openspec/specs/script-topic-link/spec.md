# script-topic-link Specification

## Purpose

Provides a many-to-many relationship between Script and Topic, enabling scripts to be categorized by multiple topics and topics to be associated with multiple scripts.
